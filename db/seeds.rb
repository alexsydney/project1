...
r4 = Restaurant.create name: 'Fish At The Rocks', address: '29 Kent St, Sydney, New South Wales 2000, Australia', location: 'Sydney', url_website: 'http://www.fishattherocks.com.au/', user: u3

r5 = Restaurant.create name: 'love.fish Barangaroo', address: 'Wulugul Walk, 7/23 Barangaroo Avenue, Wulugul Walk Barangaroo, Sydney, New South Wales 2000 Australia', location: 'Sydney', url_website: 'http://www.lovefish.com.au/', user: u2
...
i5 = Image.create title: 'WARM THAI BEEF SALAD', description: 'Spanish onion, capsicum, cherry tomatoes and crispy noodles, caramelised cashews with a spicy Thai dressing', image_url: 'http://img.taste.com.au/jXo3mTmV/taste/2016/11/thai-beef-salad-20774-1.jpeg', user: u3 ,restaurant:r5
...
i8 = Image.create title: 'Dry aged grass fed beef rib', description: 'Dry aged grass fed beef rib', image_url: 'http://bentlyranch.com/images/beef_3.jpg', user: u1 ,restaurant: r3
...
re6 = Review.create title: 'Name and location', body: 'A restaurant situated in the heart of a small village between three national forests and close to the horse´s capital city, Chantilly. It is the favourite hangout place for people from the polo, horse races, and golf world', rating: 4.5, user: u1 , restaurant:r6

re7 = Review.create title: 'Menu and dishes', body: 'The menu offers a wide variety of mouth-watering starters. I had the white asparagus accompanied by a mousseline sauce and poached eggs, while my friend tried the zucchini carpaccio served with sundries tomatoes and a mozzarella strudel. They were exquisite. The main course consisted in a risotto with scallop cooked in cream and a cassolette of coley with mussels, which really thrilled us. It all was followed by a delicious apple pie served with a scoop of vanilla ice cream for dessert.', rating: 4, user: u1 , restaurant: r7

re8 = Review.create title: 'Atmosphere and decor', body: 'As you enter the place you are welcomed by a magnificent setting, a delightful marriage of antique cut stones and the luxuries of modernity.  Sitting in any table you have a wonderful view of the workshop-like kitchen where you can see the chefs working. For those who do not book a table and are waiting, there is a cosy lounge with aged leather armchairs and pictures of polo players displayed on the walls', rating: 5, user: u1, restaurant: r8
...
re12 = Review.create title: 'Recommendation', body: 'Despite the high price of the food and the not so attentive waiters´ service, I had a pleasant dining experience with food of the most exquisite flavours. For this reason I highly recommend going to this restaurant.',rating: 5, user: u1 , restaurant: r2
...
re15 = Review.create title: 'Name and location', body: 'A restaurant situated in the heart of a small village between three national forests and close to the horse´s capital city, Chantilly. It is the favourite hangout place for people from the polo, horse races, and golf world', rating: 5, user: u3 , restaurant: r5

re16 = Review.create title: 'Name and location', body: 'A restaurant situated in the heart of a small village between three national forests and close to the horse´s capital city, Chantilly. It is the favourite hangout place for people from the polo, horse races, and golf world', rating: 4.5, user: u4 , restaurant: r6

re17 = Review.create title: ' Menu and dishes', body: 'The menu offers a wide variety of mouth-watering starters. I had the white asparagus accompanied by a mousseline sauce and poached eggs, while my friend tried the zucchini carpaccio served with sundries tomatoes and a mozzarella strudel. They were exquisite. The main course consisted in a risotto with scallop cooked in cream and a cassolette of coley with mussels, which really thrilled us. It all was followed by a delicious apple pie served with a scoop of vanilla ice cream for dessert.', rating: 1.5, user: u5 , restaurant: r7

re18 = Review.create title: 'Name and location', body: 'A restaurant situated in the heart of a small village between three national forests and close to the horse´s capital city, Chantilly. It is the favourite hangout place for people from the polo, horse races, and golf world', rating: 4.5, user:u1 , restaurant:r8

re19 = Review.create title: 'Menu and dishes', body: 'The menu offers a wide variety of mouth-watering starters. I had the white asparagus accompanied by a mousseline sauce and poached eggs, while my friend tried the zucchini carpaccio served with sundries tomatoes and a mozzarella strudel. They were exquisite. The main course consisted in a risotto with scallop cooked in cream and a cassolette of coley with mussels, which really thrilled us. It all was followed by a delicious apple pie served with a scoop of vanilla ice cream for dessert.', rating: 4, user: u1 , restaurant: r9

re20 = Review.create title: 'Atmosphere and decor', body: 'As you enter the place you are welcomed by a magnificent setting, a delightful marriage of antique cut stones and the luxuries of modernity.  Sitting in any table you have a wonderful view of the workshop-like kitchen where you can see the chefs working. For those who do not book a table and are waiting, there is a cosy lounge with aged leather armchairs and pictures of polo players displayed on the walls', rating: 5, user: u1, restaurant: r10
